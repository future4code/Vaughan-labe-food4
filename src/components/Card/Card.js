...
import { ContainerCard, ContainerPopup, DivButtonPopup, StyleSelect, TitlePopup } from "./styled";

const Card = ({ photo, name, description, price, foodAll, quantityA, openQuantity, quantityCard  }) => {
    const {cart, setCart, food, quantityAll, setQuantityAll} = useContext(GlobalStateContext)
            ...
            <div className="popup-wrapper">
                <div id="popup" className="popup">
                    <ContainerPopup>
                        ...
                        <DivButtonPopup>
                            <button className="ButtonPopup" onClick={()=>addToCart(food)}>Adicionar ao carrinho</button>
                        </DivButtonPopup>
                    </ContainerPopup>
                </div>
            </div>
            ...
            <div className="last">
                {quantityA > 0 ?
                    <>
                        ...
                        <button onClick={()=>removeTheFood()} className="remove">remover</button>
                    </>
                    :
                    <div className="add">
                    <button onClick={openQuantity} className="add-btn">Adiconar</button>
                    </div>
                }
